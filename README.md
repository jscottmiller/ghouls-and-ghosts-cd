...
**Status:** working v1 — the six level themes and the boss theme (stages 1
and 3 confirmed) play from CD; all other cues fall back to the original FM
music. Tested on RetroArch (Genesis Plus GX
...
- `GhoulsnGhostsCD.cue` + `GhoulsnGhostsCD.bin` — CD audio
